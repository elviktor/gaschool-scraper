...
masterData_df = pd.DataFrame(fiscalYear_list)
...
for countyName_selectorCounter in range(0, countyName_df_length):
    ...
    masterData_df = pd.concat([masterData_df, schoolData_df_transpose], axis=1)
    #=================================================================

# Place in alphabetical order by school name
masterData_df_sorted = masterData_df.sort_values(axis=1, by=[0])
...
documentFileName = 'blackPercentage_full'
